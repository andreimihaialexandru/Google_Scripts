...
const DATE_THRESHOLD = "LAST_30_DAYS"
   ...
   var rows = AdsApp.search(
      "SELECT search_term_view.search_term,campaign.name,campaign.status,campaign.id,metrics.conversions,metrics.cost_micros,metrics.average_cpc,metrics.clicks" +
